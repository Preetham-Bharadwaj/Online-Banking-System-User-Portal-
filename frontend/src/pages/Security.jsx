                     ...
                     <div className="flex justify-center gap-3 py-4">
                        {[0, 1, 2, 3].map((i) => (
                           <input
                              ...
                              type="password"
                              inputMode="numeric"
                              className="w-16 h-16 bg-slate-50 border-2 border-slate-100 rounded-2xl text-center text-4xl font-black focus:border-primary-500/20 focus:bg-white outline-none transition-all"
                              value={upiPin[i] || ''}
                              onKeyDown={(e) => {
                                 if (e.key === 'Backspace' && !upiPin[i] && i > 0) {
