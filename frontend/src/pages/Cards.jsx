...
const Cards = () => {
  ...
  const eligibleEmiTransactions = [
    { name: 'Apple Store', date: 'Oct 24', amount: 89000, emiOption: '₹7,416 x 12 months' },
    { name: 'Reliance Digital', date: 'Oct 21', amount: 45000, emiOption: '₹3,750 x 12 months' },
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
           <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2">
                <ShieldCheck size={14} className="text-emerald-500" /> PCI DSS Certified Platform • Vertex Secure
              </div>
           </div>
                 ...
                 <div className="pt-8 border-t border-white/10 space-y-6 relative z-10">
                    <div className="flex justify-between items-center">
                       <div className="flex items-center gap-3">
                          ...
                          <div>
                             <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none mb-1">Vertex Rewards</p>
